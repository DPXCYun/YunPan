...
public class FileQueryServiceTest {
    ...
    public void renameFileTest(){
        try {
            R r = fileQueryController.renameFile( "qiqi", 1l);
...
//    }
    ...
    public void renameFolderTest(){
        try {
            R r = fileQueryController.renameFolder( 1l, "refolder");
            System.out.println(r);
        }catch (Exception e){
            throw new RuntimeException();
        }
    ...
    public void deleteFolderTest(){
        try {
            R r = fileQueryController.deleteFolder( 2l);
            System.out.println(r);
        }catch (Exception e){
            throw new RuntimeException();
        }
    ...
    public void createFolderTest(){
        try {
            R r = fileQueryController.createFolder("/test1/", "folder01");
            System.out.println(r);
        }catch (Exception e){
            throw new RuntimeException();
        }
    ...
    public void getFilesByFolderPathTest(){
        try {
            R r = fileQueryController.getFilesByFolderPath("/path/");
            System.out.println(r);
        }catch (Exception e){
            throw new RuntimeException();
        }
    ...
    public void moveFileTest(){
        try {
            R r = fileQueryController.moveFile(6l, "/test/folder/");
            System.out.println(r);
        }catch (Exception e){
            throw new RuntimeException();
        }
    ...
    public void moveFolderTest(){
        try {
            R r = fileQueryController.moveFolder(1l, "/lj/test/folder1/");
            System.out.println(r);
        }catch (Exception e){
            throw new RuntimeException();
        }
